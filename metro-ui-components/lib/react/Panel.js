...
if (!process.env.ALEX_UI_IGNORE_CSS) { require('./Panel.css'); }
...
var Panel = function (_Component) {
    ...
    Panel.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            'div',
            { className: (0, _classnames2.default)('m-panel', className) },
            children
        );
    };
...
Panel.Header = _PanelHeader2.default;
Panel.Footer = _PanelFooter2.default;
Panel.Content = _PanelContent2.default;
