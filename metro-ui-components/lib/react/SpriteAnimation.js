...
var moduleClassName = (0, _moduleClassNameFactory2.default)('m-spriteAnimation');

var SpriteAnimation = function (_Component) {
    _inherits(SpriteAnimation, _Component);
    ...
    SpriteAnimation.loadImage = function loadImage() {
    ...
    SpriteAnimation.prototype.loadSprite = function loadSprite() {
        var _this2 = this;
        ...
        if (!isLoaded && !hasErrored) {
            SpriteAnimation.loadImage(sprite, function (err, image) {
                if (err) {
                    onError(err);
                    // dont trigger update
    ...
    SpriteAnimation.prototype.componentDidMount = function componentDidMount() {
        this.loadSprite();

        this.propsUpdatedAt = Date.now();
    };

    SpriteAnimation.prototype.componentDidUpdate = function componentDidUpdate() {
        var _this3 = this;
    ...
    SpriteAnimation.prototype.animate = function animate(nextFrame, time) {
        var _this4 = this;
    ...
    SpriteAnimation.prototype.componentWillReceiveProps = function componentWillReceiveProps(_ref) {
    ...
    SpriteAnimation.prototype.componentWillUnmount = function componentWillUnmount() {
    ...
    SpriteAnimation.prototype.getSpritePosition = function getSpritePosition() {
    ...
    SpriteAnimation.prototype.reset = function reset() {
        this.setState({
            currentFrame: this.props.startFrame
        });
    };

    SpriteAnimation.prototype.render = function render() {
