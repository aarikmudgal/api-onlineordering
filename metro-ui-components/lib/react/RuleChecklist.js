...
if (!process.env.ALEX_UI_IGNORE_CSS) { require('./RuleChecklist.css'); }
...
var moduleClassName = (0, _moduleClassNameFactory2.default)('m-ruleChecklist');

function RuleChecklist(_ref) {
...
RuleChecklist.propTypes = propTypes;