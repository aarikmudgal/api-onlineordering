...
var InputPassword = function (_Component) {
    ...
    InputPassword.prototype.componentWillUnmount = function componentWillUnmount() {
        clearTimeout(this.resetStateAfterBlur);
    };

    InputPassword.prototype.handlePasswordToggle = function handlePasswordToggle(e) {
        e.preventDefault();
    ...
    InputPassword.prototype.handleBlur = function handleBlur() {
        var _this2 = this;
    ...
    InputPassword.prototype.render = function render() {
        ...
        return _react2.default.createElement(_InputBase2.default, _extends({}, props, {
...
InputPassword.propTypes = _InputBase2.default.propTypes;
InputPassword.defaultProps = (0, _objectAssign2.default)({}, _InputBase2.default.defaultProps, {
    type: 'password'
});
InputPassword.HIDE_PASSWORD_AFTER_TOUCH = 2000;
