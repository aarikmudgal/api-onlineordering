...
if (!process.env.ALEX_UI_IGNORE_CSS) { require('./FileDropzone.css'); }
...
var moduleClassName = (0, _moduleClassNameFactory2.default)('m-fileDropzone');
...
FileDropzone.Button = function (_ref2) {
...
FileDropzone.Button.displayName = 'FileDropzone.Button';